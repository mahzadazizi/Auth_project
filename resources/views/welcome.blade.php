                            ...
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item ms-3">
                                        ...
                                        @if (Route::has('login'))
                                                ...
                                                @else
                                                    <a href="{{ route('login') }}" class="nav-link custom-btn custom-border-btn btn">Log in</a>
                                 </li>
                                 <li class="nav-item ms-3">
                               
                                                    @if (Route::has('register'))
                                                        <a href="{{ route('register') }}" class="nav-link custom-btn custom-border-btn btn">Register</a>
                                                    @endif
                                                @endauth
                                        @endif
